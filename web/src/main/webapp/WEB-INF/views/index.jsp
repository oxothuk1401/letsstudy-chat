...
<%@ include file="include/header.jsp" %>
				...
				<div class="col-md-12 text-center">
					<div class="row">
						<div class="col-xs-12 col-md-8 col-md-offset-2">
							<p class="headerP">ОБУЧЕНИЕ БЕЗ ГРАНИЦ С LetsStudy.com вы можете легко изучать любой иностранный язык. Более 1000 квалифицированных преподавателей со всего мира помогут вам в этом.</p>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-12">
					<div class="row">
						<div class="col-xs-12 col-md-6 text-center">
							<button type="button" class="btn btn-default marginBottom15px" id="regTeacher">Зарегистрируйся как преподаватель</button>
						</div>
						  		...
						  		<div class="modal-dialog">
							    	...
							    	<div class="modal-content">
								    	<div class="modal-header modalHeaderStyle">
								        	<p class="fontSize24px text-left">Преподаватель</p>
								        	<p class="text-center fontSize30px">ЗАВЕСТИ АККАУНТ</p>
								        	<div class="text-center">
									          	<img src="/resources/images/icons/gplus.png" class="btn padding0 marginRight20px">
									          	<img src="/resources/images/icons/vkontakte.png" class="btn padding0 marginRight20px">
									          	<img src="/resources/images/icons/facebook.png" class="btn padding0 marginRight20px">
								        	</div>
								        </div>
						...
						<div class="col-xs-12 col-md-6  text-center">
							<button type="button" class="btn btn-default marginBottom15px" id="regStudent">Зарегистрируйся как студент</button>
						</div>
						    ...
						    <div class="modal fade" id="studentModal" role="dialog">
						  		<div class="modal-dialog">
							    	...
							    	<div class="modal-content">
								    	<div class="modal-header modalHeaderStyle">
								        	<p class="fontSize24px text-left">Студент</p>
								        	<p class="text-center fontSize30px">ЗАВЕСТИ АККАУНТ</p>
								        	<div class="text-center">
									          	<img src="/resources/images/icons/gplus.png" class="btn padding0 marginRight20px">
									          	<img src="/resources/images/icons/vkontakte.png" class="btn padding0 marginRight20px">
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-md-12 text-center">
					<p class="section1Header">ИЗУЧАТЬ ЯЗЫК ОНЛАИН ЭТО - </p>
				</div>
				<div class="col-md-12 text-center marginBottom15px">
					<div class="row">
						<div class="col-xs-4 col-md-4">эффективно</div>
						<div class="col-xs-4 col-md-4">интересно</div>
						<div class="col-xs-4 col-md-4">практично</div>
					</div>
				</div>
				<div class="col-xs-12 col-md-12">
					<div class="row">
							...
							<div class="row">
								<div class="col-xs-12 col-md-12 marginBottom15px">
									<div class="row">
										...
										<div class="col-xs-12 col-md-12">
											<p class="marginBottom15px">Постройте график обучения с учетом своего стиля жизни и степени загруженности. Все, что вам нужно, – это интернет, вебкамера и гарнитура.</p>
										</div>
									</div>
								</div>
								<div class="col-xs-12 col-md-12 marginBottom15px">
									<div class="row">
										...
										<div class="col-xs-12 col-md-12">
											<p class="marginBottom15px">С нами сотрудничают коренные жители Лондона, США, Канады и т.д., с сертификатами CELTA/TEFL.</p>
										</div>
									</div>
								</div>
								<div class="col-xs-12 col-md-12 marginBottom15px">
									<div class="row">
										...
										<div class="col-xs-12 col-md-12">
											<p class="marginBottom15px">У нас нет шаблонных уроков, так как ход каждого урока выстраивается с учетом пожеланий студента и конкретно поставленных задач.</p>
										</div>
									</div>
								</div>
							</div>
	...
	<section id="section2" class="marginBottom15px text-center">
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-md-12 marginBottom15px">
					<p class="h3"><strong>Наши преподаватели – высококвалифицированные профессионалы со всего мира</strong></p>
				</div>
				<div class="col-xs-12 col-md-12 marginBottom15px">
					<div class="row">
									...
									<div class="row">
										<div class="col-xs-12 col-md-12 marginBottom15px">
											<div class="row">
												...
												<div class="col-xs-5 col-md-8">
													<div class="row">
														<div class="col-xs-12 col-md-12">
															<p class="teacherName text-left">Лиза <img src="images/icons/hurt.png"></p>
														</div>
														<div class="col-xs-12 col-md-12 text-left">
															<div class="row">
																<div class="col-xs-6 col-md-3">
																	<img src="/resources/images/icons/calendar3.png" class="btn padding0">
																</div>
																<div class="col-xs-6 col-md-3">
																	<img src="/resources/images/icons/playVideo2.png" class="btn padding0">
																</div>
															</div>
														</div>
													</div>
										...
										<div class="col-xs-12 col-md-12 marginBottom15px grey fontSize16px">
											<div class="row">
												...
												<div class="col-xs-12 col-md-12">
													<p class="text-left">Язык преподавания: <span class="styleForTags">английский</span> <span class="styleForTags">немецкий</span></p>
												</div>
											</div>
										</div>
										<div class="col-xs-12 col-md-12">
											<p class="text-left"><span class="styleForTags">ЦТ</span> <span class="styleForTags">Бизнес</span></p>
										</div>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-xs-12 col-md-12 bgStyleWhite2">
									<div class="row paddingLeft20px">
										<div class="col-xs-12 col-md-12">
											<p class="text-left fontSize24px">Лиза <img src="/resources/images/icons/ratingStars.png" class="paddingLeft30px"></p>
										</div>
										<div class="col-xs-12 col-md-12">
											<p class="text-left">Язык родной: <span class="styleForTags">русский</span></p>
											<p class="text-left">Язык преподавания: <span class="styleForTags">английский</span></p>
										</div>
									</div>
								</div>
							</div>
