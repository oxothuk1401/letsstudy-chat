	...
	<div class="container">
					...
					<form class="form-search">
						<div class="row">
							<div class="col-xs-12 col-md-10" style="padding-bottom: 10px;">
								<input type="text" class="input-medium search-query searchPanel" placeholder="поиск преподователя" style="width: 85%;">
								<button type="submit" class="btn buttonForSearchPanel"><img src="/resources/images/icons/search2.png"></button>
							</div>
						</div>
					</form>
				</div>
		...
		<div class="row">
			<aside class="col-xs-12 col-md-3">
			    ...
			    <div style="padding-bottom: 10px;">
			    	<input type="checkbox"><span class="h4" style="padding-left: 5px;"><strong>Носитель языка</strong></span>
			    </div>
			...
			<section class="col-xs-12 col-md-9">
				...
				<div class="row" style="height: 200px; border-top: 1px solid #DBDBDB; padding-bottom: 10px; margin-bottom: 10px;">
					...
					<div class="col-xs-12 col-md-4" style="padding-top: 20px; text-align: center;">
						...
						<p><span style="font-size: 12px; font-weight: 100; color: #9D9D9D">цена урока</span><b> 10 $ - 12 $</b></p>
